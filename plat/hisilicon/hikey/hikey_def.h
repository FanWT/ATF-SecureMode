...
#define PHYSYS_BASE1			0X0
#define PHYSYS_SIZE1			(TSP_SEC_MEM_BASE)

#define PHYSYS_BASE2			((TSP_SEC_MEM_BASE)+(TSP_SEC_MEM_SIZE))
#define PHYSYS_SIZE2			(0X80000000-(PHYSYS_BASE2))
